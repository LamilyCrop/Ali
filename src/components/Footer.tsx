...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-primary/10 bg-background text-foreground">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
          <div className="max-w-md">
            <a href="/" className="flex items-center gap-3">
              <img
                ...
                className="h-14 w-14 shrink-0 rounded-full border border-primary/10 bg-card p-1.5 object-contain"
              />
              <div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <a
              ...
              className="rounded-2xl border border-primary/10 bg-background p-4 transition-colors hover:border-primary/20"
            >
              <Mail className="h-5 w-5 text-primary" />
              <div className="mt-4 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-primary/70">
                Email
              </div>
